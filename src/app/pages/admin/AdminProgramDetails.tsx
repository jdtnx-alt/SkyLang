  ...
  const eliminarFicha = async (ficha: any) => {
    ...
    try {
      ...
      if (res.ok) recargar();
        ...
        alert(err.message || err.error || 'No se pudo eliminar la ficha.');
      }
    } catch {
      alert('No se pudo eliminar la ficha. Revisa tu conexión.');
    }
  };
      ...
      <div className="ml-64">
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-6">
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-4 max-w-2xl">{program.description || "No description provided for this program."}</p>
              
              <div className="flex items-center gap-6 text-sm text-gray-500">
                <div className="flex items-center gap-2">
                  <UserIcon className="w-4 h-4" />
                  <span>Main Coordinator: {program.instructor}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <div className="bg-blue-50 text-blue-700 px-6 py-4 rounded-xl text-center">
                ...
                <div className="text-sm font-medium">Total Courses (Fichas)</div>
              </div>
        ...
        <div className="p-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-bold text-gray-800">Fichas del programa</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="space-y-3 pt-4 border-t border-gray-100">
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    ...
                    <span>{course.startDate || 'Sin fecha'} — {course.endDate || 'Sin fecha'}</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    <UserIcon className="w-4 h-4 text-gray-400" />
                    <span>
                      {course.aprendices ?? 0} {course.aprendices === 1 ? 'aprendiz' : 'aprendices'}
                    </span>
                  </div>
            ...
            {courses.length === 0 && (
              <div className="col-span-full bg-white rounded-xl border border-gray-100 p-12 text-center text-gray-500">
                ...
                <p className="text-lg font-medium text-gray-600">Este programa no tiene fichas</p>
                <p>Crea la primera para poder matricular aprendices y publicar contenido.</p>
              </div>
            )}
          </div>
        </div>
